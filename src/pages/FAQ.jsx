...
function FAQ() {
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="relative min-h-[400px] w-full flex items-center justify-center bg-black bg-[url('/images/faq-hero-bg.jpg')] bg-center bg-contain bg-no-repeat text-white overflow-hidden">
