  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white">
        {/* Hero Section */}
        <section className="relative min-h-[400px] w-full flex items-center justify-center bg-black bg-[url('/images/faq-hero-mobile-new.jpg')] md:bg-[url('/images/faq-hero-desktop-new.jpg')] bg-center bg-cover bg-no-repeat text-white overflow-hidden">
