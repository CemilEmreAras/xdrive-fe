  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white">
        ...
        <section className="relative min-h-[400px] w-full flex items-center justify-center bg-black bg-[url('/images/franchise-hero-mobile.jpg')] md:bg-[url('/images/franchise-hero-desktop.jpg')] bg-center bg-cover bg-no-repeat text-white overflow-hidden">
