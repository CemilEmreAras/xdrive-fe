  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white">
        {/* Hero Section */}
        <section className="relative min-h-[400px] w-full flex items-center justify-center bg-black bg-[url('/images/about-hero-bg.jpg')] bg-center bg-contain bg-no-repeat text-white overflow-hidden">
